...
Cache writes get billed on top of input tokens, and cached turns get billed at a 90% discount by both [Anthropic](https://platform.claude.com/docs/en/about-claude/pricing) and [OpenAI](https://developers.openai.com/api/docs/pricing).  
